...
/**
 * <p>Java class for XtnsnMeetingResultDissemination complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="XtnsnMeetingResultDissemination">
 *   &lt;complexContent>
 ...
 *                   &lt;element name="MtngAthtPerson" type="{}XtnsnMtngAthrty" maxOccurs="50" minOccurs="0"/>
 *                   &lt;element name="MntsDt" type="{}ISODateTime" minOccurs="0"/>
...
@XmlType(name = "XtnsnMeetingResultDissemination", propOrder = {
    "xtnsnDt"
})
public class XtnsnMeetingResultDissemination {

    @XmlElement(name = "XtnsnDt", required = true)
    protected XtnsnMeetingResultDissemination.XtnsnDt xtnsnDt;
     ...
     * @return
     *     possible object is
     *     {@link XtnsnMeetingResultDissemination.XtnsnDt }
     *     
     */
    public XtnsnMeetingResultDissemination.XtnsnDt getXtnsnDt() {
        return xtnsnDt;
    }
     ...
     *     
     */
    public void setXtnsnDt(XtnsnMeetingResultDissemination.XtnsnDt value) {
        this.xtnsnDt = value;
    }
    ...
    public static class XtnsnDt {
        ...
        @XmlElement(name = "MtngAthtPerson")
        protected List<XtnsnMtngAthrty> mtngAthtPerson;
        @XmlElement(name = "MntsDt")
        protected XMLGregorianCalendar mntsDt;
        @XmlElement(name = "Mtg")
        ...
        /**
         * Gets the value of the mtngAthtPerson property.
         * 
         * <p>
         * This accessor method returns a reference to the live list,
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the JAXB object.
         * This is why there is not a <CODE>set</CODE> method for the mtngAthtPerson property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
         *    getMtngAthtPerson().add(newItem);
         * </pre>
         * 
         * 
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link XtnsnMtngAthrty }
         * 
         * 
         */
        public List<XtnsnMtngAthrty> getMtngAthtPerson() {
            if (mtngAthtPerson == null) {
                mtngAthtPerson = new ArrayList<XtnsnMtngAthrty>();
            }
            return this.mtngAthtPerson;
        }

        /**
         * Gets the value of the mntsDt property.
         * 
         * @return
         *     possible object is
         ...
         *     
         */
        public XMLGregorianCalendar getMntsDt() {
            return mntsDt;
        }

        /**
         * Sets the value of the mntsDt property.
         * 
         * @param value
         *     allowed object is
         *     {@link XMLGregorianCalendar }
         *     
         */
        public void setMntsDt(XMLGregorianCalendar value) {
            this.mntsDt = value;
        }
